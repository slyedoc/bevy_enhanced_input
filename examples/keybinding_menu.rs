...
use bevy::{
    ecs::relationship::RelatedSpawnerCommands, input::{common_conditions::*, keyboard::KeyboardInput, mouse::MouseButtonInput, ButtonState}, prelude::*, ui::FocusPolicy
};
...
fn setup_actions(parent: &mut RelatedSpawnerCommands<ChildOf>, settings: &KeyboardSettings) -> Entity {
    parent
        .spawn(Node {
